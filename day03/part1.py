...
# find the intersection point closest to the central port. Because the wires are on a grid, use the Manhattan
# distance for this measurement. While the wires do technically cross right at the central port where they
# both start, this point does not count, nor does a wire count as crossing with itself.
#
